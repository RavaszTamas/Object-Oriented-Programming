...
public:
    ...
    {
        BidderWithDescription->setWindowTitle(QApplication::translate("BidderWithDescription", "BidderWithDescription", nullptr));
        labelDescription->setText(QString());
        labelPrice->setText(QString());
        add100Button->setText(QApplication::translate("BidderWithDescription", "Add 100", nullptr));
        add1000Button->setText(QApplication::translate("BidderWithDescription", "Add 1000", nullptr));
    } // retranslateUi
