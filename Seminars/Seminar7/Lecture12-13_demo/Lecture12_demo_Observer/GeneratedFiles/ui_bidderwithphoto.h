...
public:
    ...
    {
        BidderWithPhoto->setWindowTitle(QApplication::translate("BidderWithPhoto", "BidderWithPhoto", nullptr));
        photoLabel->setText(QString());
        priceLabel->setText(QString());
        add2000Button->setText(QApplication::translate("BidderWithPhoto", "Add 2000", nullptr));
    } // retranslateUi
