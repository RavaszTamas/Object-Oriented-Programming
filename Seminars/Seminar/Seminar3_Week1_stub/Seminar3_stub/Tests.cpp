...
void Tests::testController()
{
	...
	repo.addSong(s);
	repo.addSong(s);
	Song s1{ "Eddie Sheeran", "I see fire", Duration{ 4, 54 }, "https://www.youtube.com/watch?v=2fngvQS_PmQ" };
	repo.addSong(s1);
	Song s2{ "Ed Sheeran", "I see ice", Duration{ 4, 54 }, "https://www.youtube.com/watch?v=2fngvQS_PmQ" };
	repo.addSong(s2);
	Controller cont{repo};
	std::vector<Song> playlist = cont.addAllSongsByArtistToPlaylist("Ed Sheeran");
