...
public:
	...
	*/
	...
	virtual void removeFromFile(Plant elementToRemove) = 0;
...
public:
	...
	virtual void removeFromFile(Plant elementToRemove)override;
...
class MemoryMyList : public FileManagerMyList
{
private:
	std::vector<Plant> mylist;
public:
	MemoryMyList(std::string newFileName);
	void openFile();
